...
class PanoramaAction (BaseAction):
    ...
    def loop(self, kwargs):
        ...
        if kwargs['pano_mode'] == 'Photo':
            ...
            self.apn.downloadPicture(apn_path, 'pics/photo_P000.jpg')
            ...
            apn_path = self.apn.takePicture()
            time.sleep(kwargs['pano_interval'])
            self.apn.downloadPicture(apn_path, 'pics/photo_G%3.3i_S%3.3i.jpg' % (kwargs['gis_counter'],kwargs['sit_counter']))
